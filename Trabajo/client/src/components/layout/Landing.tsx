...
const LandingRef: React.FC<{}> = () => {
  ...
  return isAuth ? (
    ...
    <Row className="landing-container">
      <Col xs="12" className="header-info">
          ...
          <Col xs="12" lg="5" className="landing-text">
            <div>
              ...
              <p>
                ...
                to different destinations. Yet, what if the passengers were not
                strangers and they all had to travel to the same place? What if
                there was a similar application that allowed employees to
                carpool/share rides to their workplaces? That is where Trabajo
                comes in.
              </p>
            </div>
          </Col>
          ...
          <Col xs="12" lg="5" className="left-child landing-text">
            <div>
              ...
              <p>
                ...
                many miles you save. Keep track of how much you have helped the
          ...
          <Col xs="12" lg="5" className="landing-text">
            <div>
              ...
              <p>
                ...
                like to drive, and what days you will not be participating in a
                rideshare. You can either communicate in person at work, or use
                our built in chatbox to communicate and coordinate rides with
                other users.
              </p>
            </div>
          </Col>
          ...
          <Col xs="12" lg="5" className="landing-text left-child">
            <div>
              ...
              <p>
                ...
                just pick up the nearest people to you, Trabajo will select the
                nearest people to you.
              </p>
            </div>
          </Col>
          <Col xs="12" lg="5">

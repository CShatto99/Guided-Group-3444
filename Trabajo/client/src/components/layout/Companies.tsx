      ...
      <div className={"registerContainer"}>
        ...
        <div className={"companyInfo"}>
            ...
            <div style={{display: "flex", flexDirection: "column", alignContent: "center", justifyContent: "center"}}>
                <Label for="image">Upload Image of Company - This Will Help Users Know They are Signing Up for the Right Company</Label>
                <Input style={{border: "solid 1px black"}} type="file" name="image" id="image" onChange={this.handleFile} />
            </div>
            :
            <div style={{display: "flex", flexDirection: "column", alignContent: "center", justifyContent: "center"}}>
                <img
